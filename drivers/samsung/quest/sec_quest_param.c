...
void quest_print_param_quest_data()
{
	...
	//QUEST_PRINT("previous_smd_subitem_result : %s\n", uint64ToBinary(param_quest_data.previous_smd_subitem_result));
	QUEST_PRINT("previous_smd_subitem_result :(%llu)\n", param_quest_data.previous_smd_subitem_result);
	print_result_with_item_string(param_quest_data.previous_smd_subitem_result, STR_SUBITEM);

	QUEST_PRINT("naturescene_info : \n");
	QUEST_PRINT(" tested_times(%d) total_elapsed_time(%d)\n",
		param_quest_data.naturescene_tested_times,
		param_quest_data.naturescene_total_elapsed_time);
...
{
	// backup previous ssir
	if ( param_quest_data.smd_subitem_result != 0 )
		param_quest_data.previous_smd_subitem_result = param_quest_data.smd_subitem_result;
	...
	// let's keep last result of naturescene
	//param_quest_data.naturescene_tested_times = 0;
	//param_quest_data.naturescene_total_elapsed_time = 0;

	// let's keep last result of thermal
	//param_quest_data.smd_quefi_init_thermal = 0;
	//param_quest_data.smd_quefi_end_thermal = 0;
	//param_quest_data.smd_suefi_init_thermal = 0;
	//param_quest_data.smd_suefi_end_thermal = 0;
