...
struct param_quest_t {
	...
	uint64_t err_codes;
	uint32_t naturescene_tested_times;
	uint32_t naturescene_total_elapsed_time;
	uint64_t previous_smd_subitem_result;
	uint32_t smd_quefi_init_thermal;
	uint32_t smd_quefi_end_thermal;
	uint32_t smd_suefi_init_thermal;
	uint32_t smd_suefi_end_thermal;
